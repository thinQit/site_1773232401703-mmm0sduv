...
export default function HeroAurora({
  badge = "Seasonal Tasting Experience",
  headline = "Savor Elevated Dining, Rooted in Warmth",
  subheadline = "Discover handcrafted dishes, curated wines, and a dining atmosphere where every detail is designed to delight.",
  ...
  return (
    <AuroraBackground auroraColors={["#f59e0b", "#ef4444", "#f97316", "#fbbf24", "#fca5a5"]}>
      <motion.div
        ...
        className="animate-fade-in-up relative flex flex-col items-center justify-center gap-4 px-4 py-24 md:py-36"
      >
        {badge && (
